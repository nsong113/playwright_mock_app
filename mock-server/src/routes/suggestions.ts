...
const questionAnswers: Record<string, string> = {
  "Physical AI에 대해서 설명해줘":
    "Physical AI는 물리적 공간에서 작동하는 인공지능 시스템입니다. 로봇, 드론, 자율주행 차량 등 실제 환경과 상호작용하며 지능적인 의사결정을 내리는 AI를 의미합니다.",
  "여기서 제일 핫한 전시가 뭐야?":
    "현재 가장 인기 있는 전시는 '미래의 로봇과 함께 살아가기' 전시입니다.",
  "어떤 AI 모델을 가지고 있어?":
    "저는 GPT-4 기반의 대화형 AI 모델과 컴퓨터 비전을 위한 Vision Transformer 모델, 그리고 물리적 환경 이해를 위한 다중 모달 AI 모델을 탑재하고 있습니다.",
};
